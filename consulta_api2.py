...
while localidade < 1 or localidade > 2 :
    ...
    if localidade == 1 :
        ...
        resultado = requests.get(f'https://servicodados.ibge.gov.br/api/v2/censos/nomes/{nome}?localidade={uf}') #ANother form of using .format')
    if localidade == 2 :
            resultado = requests.get(f'https://servicodados.ibge.gov.br/api/v2/censos/nomes/{nome}')
    
    print('''
        [1] - 1930  #This represents 0
        [2] - 1930 - 1940
        [3] - 1940 - 1950
        [4] - 1950 - 1960
        [5] - 1960 - 1970
        ...
        [9] - 2000 - 2010
          ''')
    periodo = int(input('Selecione o periodo :')) - 1 
